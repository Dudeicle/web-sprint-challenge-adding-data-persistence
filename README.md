...
1. Explain the difference between `Relational Databases` and `SQL`.
   ...
   1. I think the difference is the access to data, the relational database is more dynamic allowing a greater range of access to the data

2. Why do tables need a `primary key`?

   2. Tables need primary keys so that the table itself has a linear key or id to identify the individual rows with

3. What is the name given to a table column that references the primary key on another table.

   3. A foreign key is the name given

4. What do we need in order to have a _many to many_ relationship between two tables.

   4. A many to many relationship is actually multiple one to many relationships
